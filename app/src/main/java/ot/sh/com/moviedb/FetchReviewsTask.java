 ...
 */
public class FetchReviewsTask extends AsyncTask<String, Void, ArrayList<Trailer>> {
    private final String LOG_TAG = FetchReviewsTask.class.getSimpleName();
    private Activity aContext;

    private ArrayList<Trailer> getReviewsFromJSON(String reviewsStr) throws JSONException {
        ...
        JSONObject reviewJson = new JSONObject(reviewsStr);
        ...
        for (int i = 0; i < reviewArray.length(); i++) {
            ...
            JSONObject t = reviewArray.getJSONObject(i);
            id = t.getString(M_ID);
    ...
    protected ArrayList<Trailer> doInBackground(String... params) {
        ...
        String review_id = params[0];
        Log.d(LOG_TAG, review_id);

        try {
            final String BASEURL_VIDEO = "http://api.themoviedb.org/3/movie/";
            final String STR_REVIEW = "/reviews?";
            final String URL = BASEURL_VIDEO + review_id + STR_REVIEW;
        ...
        try {
            return getReviewsFromJSON(reviewsStr);
